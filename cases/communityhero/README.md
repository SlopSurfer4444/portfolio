...
**Коллеги используют CommunityHero для работы с комментариями LikeAvto через адаптер Angry.Space.** Очередь, обсуждение, черновики и ассистент собраны в одном интерфейсе. Перед публикацией ответ проверяет и подтверждает человек.
...
Когда коллеги заинтересовались инструментом, я подключил уже развивающуюся платформу к Angry.Space для раннего использования, не дожидаясь прямых интеграций с соцсетями. Так две линии разработки сошлись: адаптер стал мостом для раннего использования CommunityHero.
...
Живой рабочий интерфейс LikeAvto: очередь, выбранное обсуждение и панель ассистента. Снимки опубликованы с разрешения. В панели открыт существующий разговор, который может относиться к другому комментарию.
...
[Публичные исходники CommunityHero](https://github.com/SlopSurfer4444/CommunityHero-public) · [Снимок от 23 сентября 2026](https://github.com/SlopSurfer4444/CommunityHero-public/tree/ebc21b051bcd0cb3d68fe265081da0ff7eddae71)
...
Rust, PostgreSQL, программный адаптер Angry.Space, локальный Whisper на GPU и интеграция языковых моделей.
