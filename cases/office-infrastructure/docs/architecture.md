...
Пользователь видит обзор офиса, сотрудников и доступ к папкам, свободное место, сведения о резервном копировании и защите данных, камеры и журнал. Сервер определяет доступные действия по роли и проверяет разрешение на конкретную операцию. Брокер обращается к оборудованию и сверяет результат; административные пароли остаются на серверной стороне.
